  ...
  return (
    <div className = "flex flex-col w-full h-full">
        ...
        <div className = "flex flex-col flex-grow relative justify-center items-center">
            ...
            <h2 className = "md:text-md l:text-md xl:text-l 2xl:text-xl 3xl:text-xl 4xl:text-2xl text-center p-2">IB Vault features hundreds of technical investment banking questions, as well as an interactive grading system that utilizes OpenAI's latest GPT model.</h2>
            <GoToQuestions/>
        </div>
        <Footer/>
    </div>
